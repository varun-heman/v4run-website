...
.proj-detail__body a,.proj-detail__body a:link,.proj-detail__body a:visited{color:var(--accent);text-decoration:none;background-image:linear-gradient(rgba(184,240,210,.4),rgba(184,240,210,.4));background-repeat:no-repeat;background-position:0 100%;background-size:100% 1px;transition:background-size .2s ease,color .2s ease;}
.proj-detail__body a:hover{color:#d4ffe6;background-size:100% 2px;}
