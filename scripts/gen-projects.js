...
.proj-detail__back{display:inline-flex;align-items:center;gap:6px;font-family:var(--mono);font-size:10px;letter-spacing:.14em;text-transform:uppercase;color:var(--fg-dim);margin-bottom:36px;cursor:pointer;transition:color .2s;}
.proj-detail__back:hover{color:var(--accent);}
...
.proj-detail__body a{color:var(--accent);border-bottom:1px solid rgba(184,240,210,.3);}
...
.proj-detail__live{display:inline-flex;align-items:center;gap:8px;margin-top:28px;padding:10px 18px;border:1px solid rgba(100,255,160,.4);border-radius:3px;color:rgb(100,255,160);font-family:var(--mono);font-size:10px;letter-spacing:.12em;text-transform:uppercase;transition:background .2s;}
.proj-detail__live:hover{background:rgba(100,255,160,.08);}
...
<main id="project-content" data-slug="${p.slug}">
  <div class="proj-detail">
    ...
    <div class="proj-detail__content">
      <a class="proj-detail__back" href="/#projects">&larr; Projects</a>
